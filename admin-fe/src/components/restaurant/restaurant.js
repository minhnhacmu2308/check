      ...
      return (
        <div className="form-group">
          <div className="col-lg-offset-2 col-lg-10">
            <button
              onClick={() => this.props.addRestaurant(this.state.name)}
            ...
            <button
              disabled
              onClick={() =>
                this.props.updateRestaurant(this.state.id, this.state.name)
              }
              className="btn-custom"
            >
              Update
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <ol className="breadcrumb">
              ...
              <li>
                <i className="fa fa-th-list" />Restaurant Manager
              </li>
            </ol>
          </div>
        </div>
            ...
            <section className="panel">
              ...
              <table className="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  {this.props.restaurant.map((element, index) => {
                    return (
                      <tr>
                        <td>{element.name}</td>
                        <td>
