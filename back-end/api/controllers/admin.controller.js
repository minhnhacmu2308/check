...
exports.addfood = async (req, res) => {
    ...
    const {category,id_category,restaurant, id_restaurant, name, price, release_date, describe, chef ,amount} = req.body;
...
exports.updatefood = async (req, res) => {
    ...
    let { name, id, category,id_category,restaurant,id_restaurant, price, release_date, describe,chef,amount} = req.body;
